...
public class FamilyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       final ArrayList<Word> words = new ArrayList<Word>();
        ...
        Word w = new Word("mother","aai",R.drawable.family_mother , R.raw.mother);
        words.add(w); //one method for adding numbers

        words.add(new Word("father","baba",R.drawable.family_father, R.raw.father));//second methog of adding words
        words.add(new Word("sister","bahin",R.drawable.family_older_sister, R.raw.sister));
        words.add(new Word("brother","bhau",R.drawable.family_older_brother, R.raw.brother));
        words.add(new Word("husband","navra",R.drawable.family_grandfather, R.raw.husband));
        words.add(new Word("wife","bayako",R.drawable.family_grandmother, R.raw.wife));
        words.add(new Word("son","mulga",R.drawable.family_son, R.raw.son));
        words.add(new Word("daughter","mulgi",R.drawable.family_son, R.raw.daughter));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int posion, long id) {
                ...
                if(result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {//AUTOFOCUS IS GRANTED
                    ...
                    mediaPlayer = MediaPlayer.create(FamilyActivity.this, w.getmAudioFile()); // or view.getContext()
                    mediaPlayer.start();
                    ...
                    mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() { //pop up the mess when song playing is done ...asyn call back ...calls when done
                        ...
                        public void onCompletion(MediaPlayer mediaPlayer) {
                            Toast.makeText(FamilyActivity.this, "I am done playing", Toast.LENGTH_SHORT).show();
                            releaseMediaPlayer();
                        }
                    });
                }
